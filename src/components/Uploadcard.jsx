...
function Uploadcard() {
  ...
  useEffect(() => {
    // If an image URL is set, show the success notification automatically
    if (imageUrl) {
      toast.success("Image uploaded successfully!");
    }
  }, [imageUrl]); // This will run every time imageUrl changes
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${apiUrl}/api/document/upload-image`,
        formData,
        {
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        `${apiUrl}/api/document/add-document`,
        cardData,
        {
          headers: {
