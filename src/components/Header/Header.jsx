  ...
  return (
    <>
      {windowSize.width >= 770 ? (
        <header className="bg-gray-800 text-white p-0 w-full d-flex align-items-center justify-content-between">
          <div className="nav-left d-flex align-items-center">
            <img src={logo} alt="Website Logo" className="website-logo" />
            <span className="text-xl font-bold ml-2">Secure-Self</span>
          </div>
          ...
          <div className="nav-right align-items-center mr-[30px]">
            {isLogin === false ? (
              ...
              <ul className={`d-flex align-items-center gap-15 mb-0 ${mobileMenuOpen ? "d-none" : "d-flex"}`}>
                <li className="profile-logo">
                  <Avatar name={userDetails.name} size="30" round={true} />
                </li>
                <li>
      ...
      {windowSize.width < 770 ? (
        <header className="bg-gray-800 text-white px-2 w-full d-flex flex-column justify-content-center">
          <div className="d-flex flex-row w-100 justify-content-between p-0">
            <div className="d-flex flex-row justify-content-center">
              <img src={logo} alt="Website Logo" className="website-logo" width={100} />
            </div>
            <div className="hamburger" onClick={() => setMobileMenuOpen(!mobileMenuOpen)}>
              <MdOutlineMenu />
            </div>
